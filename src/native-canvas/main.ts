...
export class FnApp {
  ...
  drawGrid() {
    ...
    const [gridWidth, gridHeight, fixedCount] = this.calcGridSize(
      xLen,
      gridCount
    );
    ...
    for (; i * gridWidth < rightX; i++) {
      ...
      this.fillText(
        String(this.formatNum(i * gridWidth, this.fixedCount)),
        x,
        height,
        this.fontSize,
        TextAlign.Center
    ...
    for (; j * gridHeight < rightY; j++) {
      ...
      this.fillText(
        String(this.formatNum(j * gridHeight, this.fixedCount)),
        0,
        y,
        this.fontSize,
        TextAlign.Middle
